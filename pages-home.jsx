...
const SERVICES = [
  { id: 'master',  name: 'Master Bath Remodel',   icon: '01', desc: "From layout reconfigurations to full gut renovations. We design master baths that feel like a private spa — every morning.",          points: ['Layout & spatial design', 'Custom vanities', 'Stone & tile selection', 'Lighting & ventilation'], img: PHOTOS[22] },
  { id: 'spa',     name: 'Spa & Wet Rooms',       icon: '02', desc: "Steam showers, curbless wet rooms, soaking tubs, heated stone. Built to feel like a five-star resort and run for thirty years.",       points: ['Steam & rain showers',   'Curbless wet rooms', 'Soaking & freestanding tubs', 'Heated floors & towel rails'], img: PHOTOS[18] },
  { id: 'powder',  name: 'Powder & Guest Baths',  icon: '03', desc: "Small rooms, big moments. Powder rooms are where we get to take real swings — bold stone, jewel-like fixtures, hand-painted finishes.", points: ['Statement stone & paneling','Designer fixtures',  'Custom millwork',          'Specialty wallcoverings'], img: PHOTOS[11] },
  { id: 'walk-in', name: 'Walk-In Showers',       icon: '04', desc: "Tub-to-shower conversions and curbless walk-ins, engineered for proper drainage and built with bookmatched slab walls when you want them.", points: ['Tub-to-shower conversions','Curbless installs',   'Linear & hidden drains',   'Bookmatched slab walls'], img: PHOTOS[24] },
  { id: 'aging',   name: 'Aging-In-Place',        icon: '05', desc: "Accessibility done beautifully. Zero-threshold showers, hidden grab bars, and seated benches that look like they belong in a magazine.",   points: ['Zero-threshold showers',  'Concealed grab bars', 'Comfort-height fixtures',  'Slip-resistant honed stone'], img: PHOTOS[14] },
  { id: 'vanity',  name: 'Custom Vanities',       icon: '06', desc: "Custom-built vanities tailored to your space. Soft-close everywhere, dovetailed drawers, finishes that survive South Florida humidity.", points: ['Hand-selected veneers', 'Inset & overlay doors','Integrated stone tops',  'Lifetime workmanship warranty'], img: PHOTOS[17] },
];
        ...
        <section style={{ paddingTop: 96, paddingBottom: 64 }}>
          <div className="wrap">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr 1fr', gap: 16, alignItems: 'stretch' }}>
              <div className="ph" style={{ backgroundImage: `url(${PHOTOS[18]})`, aspectRatio: '3/4', alignSelf: 'flex-end' }}></div>
              <div className="ph" style={{ backgroundImage: `url(${PHOTOS[22]})`, aspectRatio: '16/10' }}></div>
              <div className="ph" style={{ backgroundImage: `url(${PHOTOS[14]})`, aspectRatio: '3/4', alignSelf: 'flex-start' }}></div>
            </div>
        ...
        <div className="wrap">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
            <div>
              ...
              <h2 className="h-1" style={{ marginTop: 14 }}>A spa-grade primary suite.</h2>
              <p className="lead" style={{ marginTop: 20 }}>
                Floor-to-ceiling marble, a sculptural freestanding tub on the window wall, a curbless walk-in shower with rain head, and a custom oak vanity built in our shop. Designed for slow mornings and unhurried evenings.
              </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 16 }}>
              <div className="ph" style={{ backgroundImage: `url(${PHOTOS[18]})`, aspectRatio: '4/5' }}></div>
              <div style={{ display: 'grid', gap: 16 }}>
                <div className="ph" style={{ backgroundImage: `url(${PHOTOS[14]})`, aspectRatio: '4/5' }}></div>
                <div className="ph" style={{ backgroundImage: `url(${PHOTOS[11]})`, aspectRatio: '4/5' }}></div>
              </div>
            </div>
          </div>
        </div>
