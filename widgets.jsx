...
function SignatureDetails(){
  const items = [
    { k: 'steam',    label: 'Steam showers',         img: 'images/photo-24.jpg',
    ...
    { k: 'stone',    label: 'Book-matched stone',    img: 'images/photo-18.jpg',
    ...
    { k: 'soak',     label: 'Soaking tubs',          img: 'images/photo-22.jpg',
    ...
    { k: 'mirror',   label: 'Back-lit mirrors',      img: 'images/photo-14.jpg',
